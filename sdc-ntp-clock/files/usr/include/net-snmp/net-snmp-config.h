...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--with-install-prefix=/SDC/SEIKOJob/SNMP' '--host=mipsel-openwrt-linux' 'CC=mipsel-openwrt-linux-gcc' 'CXX=mipsel-openwrt-linux-g++' 'AR=mipsel-openwrt-linux-ar' '--with-default-snmp-version=1' '--with-logfile=/sysconf/log/snmpd.log' '--with-persistent-directory=/sysconf/net-snmp' '--sbindir=/sbin' '--libdir=/usr/lib' '--with-mibdirs=/sysconf/net-snmp/snmp/mibs' '--datadir=/sysconf/net-snmp/' '--sysconfdir=/sysconf/net-snmp/' '--with-endianness=little' '--disable-debugging' '--disable-embedded-perl' '--without-perl-modules' '--without-rpm' '--enable-mini-agent' '--enable-static' '--with-mib-modules=stsChClockDigitalShmLib stsChClockDigital  if-mib ip-mib tcp-mib udp-mib' '--with-cflags=-DSTS_CH_CLOCK_HW_MATRIX' 'host_alias=mipsel-openwrt-linux'"
